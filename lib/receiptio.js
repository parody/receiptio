...
try {
    ...
    // nothing to do
    console.log('receiptio: puppeteer not found')
}
let sharp;
try {
    sharp = require('sharp');
    ...
    // nothing to do
    console.log('receiptio: sharp not found')
}
...
const rasterize = async (receiptmd, printer, encoding) => {
    console.log('receiptio: rasterizing')
    // convert receiptline to png
    ...
    if (puppeteer) {
        ...
        console.log('receiptio: rasterized using puppeteer')
        return png;
    }
    else if (sharp) {
