...
console.log('receiptio.js: receiptio library loaded');
                                        ...
                                        if (len > 1) {
                                            ...
                                            if (l <= len) {
                                                ...
                                                if (params.q === 'drawer') {
                                                    ...
                                                    state = 2;
                                                    // write command
                                                    drain = false;  // force drain to false since transform could take long time and a status could come back in the meantime
